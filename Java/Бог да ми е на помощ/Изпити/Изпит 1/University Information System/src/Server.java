...
import UserSettings.Users.Grade;
import UserSettings.Users.Student;
import UserSettings.Users.Teacher;

public class Server {
    private static final String USERS_FILENAME = "C:\\Users\\Емо Николов\\Desktop\\Проекти\\От университета\\Java\\Бог да ми е на помощ\\Изпити\\Изпит 1\\University Information System\\src\\Server_Client\\users.bin";
